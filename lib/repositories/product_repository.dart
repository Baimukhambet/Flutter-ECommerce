...
class ProductRepository {
  final List<Product> _products = [
    Product(
        ...
        price: 94.99,
        imagePath:
            'https://static.zara.net/assets/public/324b/2664/6e7d4a898516/49ed70153f28/08281355800-e1/08281355800-e1.jpg?ts=1706093265803&w=850',
    ...
    Product(
        ...
        price: 24.95,
        imagePath:
            'https://static.zara.net/assets/public/19ed/db69/3cd849afb8ac/d9f182c9f4f6/04174178629-e1/04174178629-e1.jpg?ts=1713257032622&w=850',
        category: Category.shirts,
        gender: Gender.woman),
    Product(
        ...
        price: 19.90,
        imagePath:
            'https://static.zara.net/assets/public/50e6/571a/c6bd45de9da1/7a0ac3bb8204/04424151104-e1/04424151104-e1.jpg?ts=1707930612767&w=850',
        category: Category.shirts,
        gender: Gender.woman),
  ];
